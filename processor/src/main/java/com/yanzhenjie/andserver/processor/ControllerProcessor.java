                ...
                if (formPart != null) {
                    ...
                    if (mMultipart.equals(typeName)) {
                        ...
                        handleCode.addStatement("$T param$L = null", typeName, i)
                            ...
                            .addStatement("$T param$LFile = null", mMultipart, i)
                            .beginControlFlow("if (multiRequest != null)")
                            .addStatement("param$LFile = multiRequest.getFile($S)", i, name)
                            .endControlFlow()
                            ...
                            .addStatement("String param$LStr = request.getParameter($S)", i, name)
